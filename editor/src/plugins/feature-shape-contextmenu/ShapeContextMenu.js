(function($, pluginsNamespace, util) {
    ...
    ShapeContextMenu.prototype.showContextMenu = function(fabricItem, event) {
        ...
        var $settings = $('<li><a>' +
            _this.drawerInstance.t('Settings') +
            '</a></li>');
        util.bindClick($settings.find('a'), eventsNS, this._settingsObject.bind(this, fabricItem));
        _this.$contextMenu.append($settings);
    ...
    ShapeContextMenu.prototype._settingsObject = function(fabricItem) {
        this.drawerInstance.api.settingsObject(fabricItem);
        this.hideContextMenu();
        return false;
    };
