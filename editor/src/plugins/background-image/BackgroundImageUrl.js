(function($, BaseTool, pluginsNamespace, util) {
     ...
     */
    var BackgroundImageUrlTool = function BackgroundImageToolConstructor(drawerInstance, options) {
        // call base c-tor
        BaseTool.call(this, drawerInstance);

        var _this = this;
        this.drawer = drawerInstance;
        this.name = 'BackgroundImageUrl';
        this.btnClass = 'btn-imageurl';
        this.faClass = 'fa-link';
        this.tooltip = drawerInstance.t('Insert a background image from url');
    ...
    // Derive BackgroundImageUrlTool from BaseTool
    BackgroundImageUrlTool.prototype = Object.create(BaseTool.prototype);
    BackgroundImageUrlTool.prototype.constructor = BackgroundImageUrlTool;

    /**
     * Default options.
     */
    BackgroundImageUrlTool.prototype._defaultOptions = {
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._activateTool = function() {
        var _this = this;
        this.drawerInstance.log('TOOL', 'BackgroundImageUrlTool._activateTool()');
        BaseTool.prototype._activateTool.call(this);

        var imageURL = "http://fabricjs.com/assets/jail_cell_bars.png";
        var position = 'stretch';
        var pos = {
            'imagePosition' : 'center'
        };
        _this.loadImageFromUrl(imageURL);
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._showDialog = function() {
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._processFileInput = function(e)  {
        var _this = this;
   ...
   */
  BackgroundImageUrlTool.prototype._triggerImageCrop = function (imageSrc, options) {
    var dataToEvent = {
      url: imageSrc,
     ...
     */
    BackgroundImageUrlTool.prototype.readFile = function(file, callback) {
        var _this = this;
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._checkFile = function(file) {
        var _this = this;
     ...
     */
    BackgroundImageUrlTool.prototype.loadImageFromUrl = function(imageSrc, options, throwError) {
        var _this = this;
        var image = new Image();
    ...
    BackgroundImageUrlTool.prototype.loadImageFromUrlX = function(imageSrc, throwError) {
        var _this = this;
        var fCanvas = this.drawerInstance.fCanvas;
        fCanvas.setBackgroundImage(imageSrc, fCanvas.renderAll.bind(fCanvas), {
            crossOrigin: 'anonymous'
        });
    };
     ...
     */
    BackgroundImageUrlTool.prototype.makeImageBackground = function(image, options) {
        var _this = this;
        var fCanvas = this.drawerInstance.fCanvas;
        var fabricImage = new fabric.ImageZone(image, options);
     ...
     *
     * @param  {fabric.Image} bgImage BackgroundImageUrl
     * @param  {String} imagePosition
     * @return {Object}
     */
    BackgroundImageUrlTool.prototype._calcPositioningOptions = function(bgImage, imagePosition) {
        var fCanvas = this.drawerInstance.fCanvas;
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._repositionImage = function() {
        var fCanvas = this.drawerInstance.fCanvas;
        if (!fCanvas.BackgroundImageUrl)
            return;

        var bgImage = fCanvas.BackgroundImageUrl;
    ...
    */
    BackgroundImageUrlTool.prototype.createButton = function(toolbar) {
     ...
     * @private
     */
    BackgroundImageUrlTool.prototype._throttle = function(func, ms) {
    ...
    pluginsNamespace.BackgroundImageUrl = BackgroundImageUrlTool;
