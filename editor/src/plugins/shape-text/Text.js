(function($, BaseShape, pluginsNamespace, util) {
    ...
    Text.prototype.addTextShape = function(left, top, text, styles) {
        styles = styles || {};
        left = parseInt(left, 10);
        left = left || left === 0 ? left : 0;
        top = parseInt(top, 10);
        top = top || top === 0 ? top : 0;
        //console.log('Text.prototype.addShape styles', styles);
    ...
    Text.prototype.addTickerShape = function(left, top, text, styles) {
        styles = styles || {};
        left = parseInt(left, 10);
        left = left || left === 0 ? left : 0;
        top = parseInt(top, 10);
        top = top || top === 0 ? top : 0;
        //console.log('Text.prototype.addShape styles', styles);
        var shape = this.createTickerShape(left, top, text, styles);
        shape.set('left', left);
        shape.set('top', top);
        this.shape = shape;
        // finish drawing
    ...
    Text.prototype.createShape = function(left, top, textString, styles) {
        ...
        //this.text = new fabric.TextZone(textString, {editIconMode : this.options.editIconMode, editIconSize: this.options.editIconSize});
        var zoneOptions = {
            ...
            mediaFileId: styles.mediaFileId,
            mediaPlaylistId: styles.mediaPlaylistId
        };
        this.text = new fabric.TextZone(textString, zoneOptions);
    ...
    Text.prototype.createTickerShape = function(left, top, textString, styles) {
        styles = styles || {};
        textString = textString || 'Text';
        this.startLeft = left;
        this.startTop = top;
        ...
        this.text = new fabric.TickerZone(textString, zoneOptions);
