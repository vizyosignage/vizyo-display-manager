(function($, BaseTool, pluginsNamespace, util) {
     ...
     */
    ImageTool.prototype._defaultOptions = {
    ...
    /**
     * Load image from url/imageSrc, then call addImageFromUrl()
     *
     * @param {string} imageSrc src of image http url
     * @private
     */
    ImageTool.prototype.loadImageFromUrl = function(imageSrc, options) {
        var _this = this;
        var image = new Image();
        ...
        image.onload = function() {
            _this.addImageFromUrl(image, options);
        };
     ...
     * @param {Image} image
     */
    ImageTool.prototype.addImageFromUrl = function(image, options) {
        var fCanvas = this.drawerInstance.fCanvas;
        var fabricImage = new fabric.ImageZone(image, options);
