(function ($, pluginsNamespace, BaseToolOptions, util) {
  ...
  var ColorTool = function ColorToolConstructor(drawer, options) {
     ...
     * @type {DrawerJs.plugins.JsColorpickerControl}
     */
      this.colorControl = new pluginsNamespace.JsColorpickerControl(this.drawer, this.options);
    /**
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * This function is called every time user clicks on color from opacity-control
   * menu.
   *
  ...
  ColorTool.prototype.updateControlsFromObject = function (target) {
      ...
      if (target === null) {
        color = this.drawer.fCanvas.backgroundColor;
      }else{
        // get object color
  ...
  ColorTool.prototype.showControls = function (withoutOpacity) {
    withoutOpacity = withoutOpacity !== undefined ? withoutOpacity : !this.options.showOpacityControl;
      ...
      // jscolor burada init ediliyor (html yüklendikten sonra)

      this.colorControl._initJscolor();

      // var that = this;
      // setTimeout(function() {
      //   that.colorControl._initJscolor();
      // }, 5000);
