(function ($, pluginsNamespace, util) {
  ...
  ColorpickerControl.prototype._defaultOptions = {
      ...
      //   ],
      colors: [ // red, green, blue, white to black palettes (ssahin)
  ...
  ColorpickerControl.prototype._getControlHtml = function () {
    ...
    return '<li class="colorpicker-control" ' +
            ...
            '<input type="text" class="toolbar-label" style="width: 80px; font-size: 16px"' +
                 'value="' + this.drawer.t(colorLabelText) + '" />' +
            '<span class="color-indicator" style="border: 1px solid black" ' +
                  'data-editable-canvas-sizeable="toolbar-button" ' +
