(function  (Drawer, util) {
   ...
   */
  Drawer.prototype.getImageData = function (scaleFactor) {
    this.$imageElement.attr('crossOrigin', 'Anonymous');
    
    if (this.fCanvas) {
      //this.imageData = this.fCanvas.toDataURL();
      //var mini_w = 250 / this.fCanvas.width;
      var sFactor = 1;
   ...
   */
Drawer.prototype.loadCanvasX = function (serializedCanvas) {
  var _this = this;
  if (serializedCanvas) {
    var json = JSON.stringify(serializedCanvas);
    this.fCanvas.loadFromJSON(json, this.fCanvas.renderAll.bind(this.fCanvas), function(o, object) {
      // o = json object
      // object = fabric.Object instance
      console.log("Drawer.prototype.loadCanvas serializedCanvas: " + json);
      console.log(o);
      console.log(object);
      _this._updateObjectsControls(object);
  ...
  Drawer.prototype.loadCanvas = function (serializedCanvas) {
    ...
    if (serializedCanvas) {
      this.fCanvas.loadFromJSON(serializedCanvas, function() {
        ...
        //console.log('Drawer.prototype.loadCanvas allObjects', allObjects);
  ...
  Drawer.prototype.onCanvasLoaded = function () {
    ...
    this.setSize(this.width, this.height, this.zoomFactor);
  ...
  Drawer.prototype.getCanvasJson = function () {
    return this.fCanvas.getCanvasJson();
  };

  Drawer.prototype.getCanvasClearJson = function () {
    return this.fCanvas.getCanvasClearJson();
  };
