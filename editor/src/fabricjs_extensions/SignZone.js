(function(global) {
     ...
     * @extends fabric.Text
     */
    fabric.SignZone = fabric.util.createClass(fabric.PText, {
        type: 'SignZone', // yardı dinamik trafik tabelası (yds) bilgileri
        id: 'Sign',
        ...
        initialize: function(text, options) {
            ...
            //console.log('SignZone.initialize', options);
    ...
    fabric.SignZone.fromObject = function(object, callback, forceAsync) {
        return fabric.Object._fromObject('SignZone', object, callback, forceAsync, object.text);
    };

    fabric.SignZone.async = true;

    // make our object erasable via ErasableMixin.
    //fabric.makeObjectErasable(fabric.SignZone);
