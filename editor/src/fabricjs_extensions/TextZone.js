(function(global) {
     ...
     */
    fabric.TextZone = fabric.util.createClass(fabric.PText, {
        type: 'TextZone',
        id: 'Text',
        ...
        initialize: function(text, options) {
            ...
            this.textBackgroundColor = options.textBackgroundColor || '#000000';
            ...
            //console.log('TextZone.initialize', options);
     ...
     */
    // fabric.TextZone.fromObject = function (objData) {
    //     console.log('TextZone.fromObject', objData);
    //     return fabric.Object._fromObject('TextZone', objData);
    //     //return new fabric.TextZone(objData.text, objData);
    // };

    fabric.TextZone.fromObject = function(object, callback, forceAsync) {
        return fabric.Object._fromObject('TextZone', object, callback, forceAsync, object.text);
    };

    fabric.TextZone.async = true;

    // make our object erasable via ErasableMixin.
    //fabric.makeObjectErasable(fabric.TextZone);
