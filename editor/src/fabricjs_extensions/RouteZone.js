(function(global) {
     ...
     * @extends fabric.Text
     */
    fabric.RouteZone = fabric.util.createClass(fabric.PText, {
        type: 'RouteZone', // güzergah bilgileri
        id: 'Route',
        ...
        initialize: function(text, options) {
            ...
            //console.log('RouteZone.initialize', options);
    ...
    fabric.RouteZone.fromObject = function(object, callback, forceAsync) {
        return fabric.Object._fromObject('RouteZone', object, callback, forceAsync, object.text);
    };

    fabric.RouteZone.async = true;

    // make our object erasable via ErasableMixin.
    //fabric.makeObjectErasable(fabric.RouteZone);
