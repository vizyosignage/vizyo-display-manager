...
DrawerToolbarManager.prototype.createAllToolbars = function() {
    ...
    if (!isFullscreen) {
        ...
        infoToolbar_conf = toolbarsOptions.infoTools;
    } else {
        var overridedValues = {
        ...
        settingsToolbar_conf = $.extend(true, {},
            ...
            overridedValues);
        infoToolbar_conf = $.extend(true, {},
            infoToolbar.infoTools,
            infoToolbar.infoTools.fullscreenMode || {},
            overridedValues);
    }
    ...
    //infoTools toolbar
    this.infoToolbar = new InfoToolbar(this.drawerInstance, infoToolbar_conf);
    var infoToolbarOptions = {
        position: infoToolbar_conf.position,
        positionType: infoToolbar_conf.positionType,
        customAnchorSelector: infoToolbar_conf.customAnchorSelector
    };
    //console.log('infoToolbar', this.infoToolbar);
    //console.log('infoToolbarOptions', infoToolbarOptions);
    this.addToolbar(this.infoToolbar, infoToolbarOptions);
...
DrawerToolbarManager.prototype._createToolbarsPlaceholders = function() {
    ...
    // @todo: remake this!
    var toolbarNames = ['drawingTools', 'toolOptions', 'settings', 'infoTools'];
