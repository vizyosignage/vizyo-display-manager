...
public class ManagerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ManagerGlobalFeatureConfigurator.Configure();
        ManagerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ManagerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ManagerResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Manager");

            options.DefaultResourceType = typeof(ManagerResource);
        ...
        {
            options.MapCodeNamespace("Manager", typeof(ManagerResource));
        });
    }
}
